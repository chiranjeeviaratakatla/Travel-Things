                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12 col-xs-12 col-md-12">
                                ...
                                <div style="overflow:auto">
                                    <asp:GridView ID="gvItems" runat="server" OnRowCommand="gvItems_RowCommand" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" CssClass="footable" AutoGenerateColumns="false" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="gvBtnSelect" runat="server" ImageUrl="~/Images/Icons/edit.png" CommandName="EditItem" CommandArgument="<%# Container.DataItemIndex %>" />
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="gvBtnSelect1" runat="server" ImageUrl="~/Images/Icons/delete.png" CommandName="DeleteItem" OnClientClick="return ConfirmDelete(this);" CommandArgument="<%# Container.DataItemIndex %>" />
